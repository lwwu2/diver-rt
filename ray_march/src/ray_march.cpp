...
void aabb_intersect_wrapper(
    ...
    float* o, float* v, const float* center, const float* rotation,
...
void aabb_intersect(
    at::Tensor o, at::Tensor v, at::Tensor center, at::Tensor rotation,
    at::Tensor finish, 
    at::Tensor rgba,
    at::Tensor octrees,
    int voxel_num
  ...
  aabb_intersect_wrapper(
                         ...
                         center.data_ptr<float>(), rotation.data_ptr<float>(),
